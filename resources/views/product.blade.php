                ...
                <div>
                   ...
                   <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{asset('uploads/product/' . $pro->image)}}" alt="" style="width:400px; margin-left:42
                        0px">
                        <h6 class="text-uppercase">{{$pro->name}}</h6>
                        <h5 class="text-primary mb-0">{{$pro->price}}</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href=""><i class="bi bi-cart"></i></a>
                            <a class="btn btn-primary py-2 px-3" href="{{ url('more/' . $pro->id) }}"><i class="bi bi-eye"></i></a>
                        </div>
                    </div>
